    ...
    <div class="formbold-form-wrapper">
      <form action="https://formbold.com/s/FORM_ID" method="POST">
        <div class="formbold-input-flex">
          <div>
            <input type="text" name="id_evidencia" id="id_Evidencia" placeholder="id_evidencia" class="formbold-form-input" />
            <label for="Evidencia" class="formbold-form-label"> Número de Evidencia </label>
          </div>
          <div>
            <input type="text" name="id_caso" id="id_caso" placeholder="id_caso" class="formbold-form-input" />
            <label for="Caso" class="formbold-form-label"> Número de Caso </label>
          </div>
        </div>

        <div class="formbold-input-flex">
          <div>
            <input type="id_usuario" name="id_usuario" id="id_usuario" placeholder="id_usuario" class="formbold-form-input" />
            <label for="Usuario" class="formbold-form-label"> Usuario </label>
          </div>
          <div>
            <select name="id_evidencia" id="id_evidencia" class="formbold-form-input">
            ...
            <label for="id_evidencia" class="formbold-form-label">Tipo de Evidencia</label>
          </div>
        </div>
